...
from backend.models.admin import (
    AdminLoginRequest, AdminPostCreate, AdminPostUpdate,
    AdminProjectCreate, AdminProjectUpdate,
...
async def admin_writings_edit_get(
    id: str,
    current_user: Dict[str, Any] = Depends(get_current_user),
    db: firestore.Client = Depends(get_db)
):
...
async def admin_writings_edit_put(
    id: str,
...
async def admin_writings_delete(
    id: str,
    current_user: Dict[str, Any] = Depends(get_current_user),
    db: firestore.Client = Depends(get_db)
):
...
async def admin_projects_new(
    project_data: AdminProjectCreate,
    current_user: Dict[str, Any] = Depends(get_current_user),
    db: firestore.Client = Depends(get_db)
):
...
async def admin_projects_edit_get(
    id: str,
    current_user: Dict[str, Any] = Depends(get_current_user),
    db: firestore.Client = Depends(get_db)
):
...
async def admin_projects_edit_put(
    id: str,
...
async def admin_products_edit_get(
    id: str,
    current_user: Dict[str, Any] = Depends(get_current_user),
    db: firestore.Client = Depends(get_db)
):
...
async def admin_products_edit_put(
    id: str,
